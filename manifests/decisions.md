...
| 098 | 2026-08-10 | O retângulo do SVG fica em **cache**; `getBoundingClientRect` sai do caminho do `mousemove` | Era a causa real do travamento, e o teto de pontos só tinha adiado o sintoma: medir um elemento SVG força o navegador a recalcular o layout da árvore inteira, e isso rodava 60×/s sobre milhares de nós. Não é custo de React — é thrash de layout, e por isso escala com o número de nós desenhados, não com a reconciliação | ativa |
